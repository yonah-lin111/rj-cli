...
export const helpText = (): string => {
  const keybindings = [
    ...
    "Ctrl+O".padEnd(16) + "Open the latest subagent detail view",
    "Ctrl+Z".padEnd(16) + "Undo in the editor",
    ...
    "Space".padEnd(16) + "Toggle setting items in the settings selector",
  ];
  const notes = [
    "Tips:",
    "!command".padEnd(16) + "Run a bash command, e.g. !pwd",
    "/webUI".padEnd(16) + "Open the embedded Web UI in your browser",
    "/setting".padEnd(16) + "Open the settings selector",
    "/info [RJ号]".padEnd(16) + "Show the last QA RJ or a specific RJ in []",
